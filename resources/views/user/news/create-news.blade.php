    ...
    <div class="row card">
        <div class="col-md-10 col-md-offset-1">
            <div class="card-hover-shadow-2x mb-3 mt-3 card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('user.news.create')}}" method="post" class="form-group" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                ...
                                <div style="width: 80%; margin: auto;">
                                    <textarea  name="news_body" id="new-post" rows="5" class="form-control" placeholder="Write News Body here ..." ></textarea>
                                </div>
                                <br>
...
function showResult(str) {
    $.ajax({
        method: 'POST',
        url: '{{ route('user.news.search.player')}}',
        data:{q: str,"_token": "{{ csrf_token() }}", from:'user'}
...
function showTeamResult(str) {
    $.ajax({
        method: 'POST',
        url: '{{ route('user.news.search.team')}}',
        data:{q: str, "_token": "{{ csrf_token() }}", from:'user'}
