                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <form action="{{ route('forum.post.report.create')}}" method="post" class="form-group" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="forum_post_id" id="forum_post_id" value="{{$post_id}}" required>
                                    </div>
