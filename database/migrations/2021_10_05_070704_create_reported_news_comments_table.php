...
class CreateReportedNewsCommentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql2')->create('reported_news_comments', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('reported_news_comments');
    }
}
